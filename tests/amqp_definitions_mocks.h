...
static const RECEIVED_HANDLE test_received_handle = (RECEIVED_HANDLE)16981;
static const AMQP_VALUE test_received_amqp_value = (AMQP_VALUE)16982;
/* accepted */

static const ACCEPTED_HANDLE test_accepted_handle = (ACCEPTED_HANDLE)16982;
static const AMQP_VALUE test_accepted_amqp_value = (AMQP_VALUE)16983;
/* rejected */

static const REJECTED_HANDLE test_rejected_handle = (REJECTED_HANDLE)16983;
static const AMQP_VALUE test_rejected_amqp_value = (AMQP_VALUE)16984;
/* released */

static const RELEASED_HANDLE test_released_handle = (RELEASED_HANDLE)16984;
static const AMQP_VALUE test_released_amqp_value = (AMQP_VALUE)16985;
/* modified */

static const MODIFIED_HANDLE test_modified_handle = (MODIFIED_HANDLE)16985;
static const AMQP_VALUE test_modified_amqp_value = (AMQP_VALUE)16986;
...
/* error */
	...
	MOCK_STATIC_METHOD_1(,ERROR_HANDLE, error_clone, ERROR_HANDLE, value);
	MOCK_METHOD_END(ERROR_HANDLE, test_error_handle);
...
/* open */
	...
	MOCK_STATIC_METHOD_1(,OPEN_HANDLE, open_clone, OPEN_HANDLE, value);
	MOCK_METHOD_END(OPEN_HANDLE, test_open_handle);
	...
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_get_outgoing_locales, OPEN_HANDLE, open, AMQP_VALUE*, outgoing_locales_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_set_outgoing_locales, OPEN_HANDLE, open, AMQP_VALUE, outgoing_locales_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_get_incoming_locales, OPEN_HANDLE, open, AMQP_VALUE*, incoming_locales_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_set_incoming_locales, OPEN_HANDLE, open, AMQP_VALUE, incoming_locales_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_get_offered_capabilities, OPEN_HANDLE, open, AMQP_VALUE*, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_set_offered_capabilities, OPEN_HANDLE, open, AMQP_VALUE, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_get_desired_capabilities, OPEN_HANDLE, open, AMQP_VALUE*, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, open_set_desired_capabilities, OPEN_HANDLE, open, AMQP_VALUE, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
...
/* begin */
	...
	MOCK_STATIC_METHOD_1(,BEGIN_HANDLE, begin_clone, BEGIN_HANDLE, value);
	MOCK_METHOD_END(BEGIN_HANDLE, test_begin_handle);
	...
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, begin_get_offered_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE*, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, begin_set_offered_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, begin_get_desired_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE*, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, begin_set_desired_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
...
/* attach */
	...
	MOCK_STATIC_METHOD_1(,ATTACH_HANDLE, attach_clone, ATTACH_HANDLE, value);
	MOCK_METHOD_END(ATTACH_HANDLE, test_attach_handle);
	...
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, attach_get_offered_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE*, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, attach_set_offered_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE, offered_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, attach_get_desired_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE*, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, attach_set_desired_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE, desired_capabilities_value);
	MOCK_METHOD_END(int, 0);
...
/* flow */
	...
	MOCK_STATIC_METHOD_1(,FLOW_HANDLE, flow_clone, FLOW_HANDLE, value);
	MOCK_METHOD_END(FLOW_HANDLE, test_flow_handle);
...
/* transfer */
	...
	MOCK_STATIC_METHOD_1(,TRANSFER_HANDLE, transfer_clone, TRANSFER_HANDLE, value);
	MOCK_METHOD_END(TRANSFER_HANDLE, test_transfer_handle);
...
/* disposition */
	...
	MOCK_STATIC_METHOD_1(,DISPOSITION_HANDLE, disposition_clone, DISPOSITION_HANDLE, value);
	MOCK_METHOD_END(DISPOSITION_HANDLE, test_disposition_handle);
...
/* detach */
	...
	MOCK_STATIC_METHOD_1(,DETACH_HANDLE, detach_clone, DETACH_HANDLE, value);
	MOCK_METHOD_END(DETACH_HANDLE, test_detach_handle);
...
/* end */
	...
	MOCK_STATIC_METHOD_1(,END_HANDLE, end_clone, END_HANDLE, value);
	MOCK_METHOD_END(END_HANDLE, test_end_handle);
...
/* close */
	...
	MOCK_STATIC_METHOD_1(,CLOSE_HANDLE, close_clone, CLOSE_HANDLE, value);
	MOCK_METHOD_END(CLOSE_HANDLE, test_close_handle);
...
/* sasl-mechanisms */
	...
	MOCK_STATIC_METHOD_1(,SASL_MECHANISMS_HANDLE, sasl_mechanisms_create, AMQP_VALUE, sasl_server_mechanisms_value);
	MOCK_METHOD_END(SASL_MECHANISMS_HANDLE, test_sasl_mechanisms_handle);
	MOCK_STATIC_METHOD_1(,SASL_MECHANISMS_HANDLE, sasl_mechanisms_clone, SASL_MECHANISMS_HANDLE, value);
	MOCK_METHOD_END(SASL_MECHANISMS_HANDLE, test_sasl_mechanisms_handle);
	...
	MOCK_STATIC_METHOD_2(, int, sasl_mechanisms_get_sasl_server_mechanisms, SASL_MECHANISMS_HANDLE, sasl_mechanisms, AMQP_VALUE*, sasl_server_mechanisms_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, sasl_mechanisms_set_sasl_server_mechanisms, SASL_MECHANISMS_HANDLE, sasl_mechanisms, AMQP_VALUE, sasl_server_mechanisms_value);
	MOCK_METHOD_END(int, 0);
...
/* sasl-init */
	...
	MOCK_STATIC_METHOD_1(,SASL_INIT_HANDLE, sasl_init_clone, SASL_INIT_HANDLE, value);
	MOCK_METHOD_END(SASL_INIT_HANDLE, test_sasl_init_handle);
...
/* sasl-challenge */
	...
	MOCK_STATIC_METHOD_1(,SASL_CHALLENGE_HANDLE, sasl_challenge_clone, SASL_CHALLENGE_HANDLE, value);
	MOCK_METHOD_END(SASL_CHALLENGE_HANDLE, test_sasl_challenge_handle);
...
/* sasl-response */
	...
	MOCK_STATIC_METHOD_1(,SASL_RESPONSE_HANDLE, sasl_response_clone, SASL_RESPONSE_HANDLE, value);
	MOCK_METHOD_END(SASL_RESPONSE_HANDLE, test_sasl_response_handle);
...
/* sasl-outcome */
	...
	MOCK_STATIC_METHOD_1(,SASL_OUTCOME_HANDLE, sasl_outcome_clone, SASL_OUTCOME_HANDLE, value);
	MOCK_METHOD_END(SASL_OUTCOME_HANDLE, test_sasl_outcome_handle);
...
/* source */
	...
	MOCK_STATIC_METHOD_1(,SOURCE_HANDLE, source_clone, SOURCE_HANDLE, value);
	MOCK_METHOD_END(SOURCE_HANDLE, test_source_handle);
	...
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, source_get_outcomes, SOURCE_HANDLE, source, AMQP_VALUE*, outcomes_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, source_set_outcomes, SOURCE_HANDLE, source, AMQP_VALUE, outcomes_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, source_get_capabilities, SOURCE_HANDLE, source, AMQP_VALUE*, capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, source_set_capabilities, SOURCE_HANDLE, source, AMQP_VALUE, capabilities_value);
	MOCK_METHOD_END(int, 0);
...
/* target */
	...
	MOCK_STATIC_METHOD_1(,TARGET_HANDLE, target_clone, TARGET_HANDLE, value);
	MOCK_METHOD_END(TARGET_HANDLE, test_target_handle);
	...
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, target_get_capabilities, TARGET_HANDLE, target, AMQP_VALUE*, capabilities_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, target_set_capabilities, TARGET_HANDLE, target, AMQP_VALUE, capabilities_value);
	MOCK_METHOD_END(int, 0);
...
/* header */
	...
	MOCK_STATIC_METHOD_1(,HEADER_HANDLE, header_clone, HEADER_HANDLE, value);
	MOCK_METHOD_END(HEADER_HANDLE, test_header_handle);
...
/* properties */
	...
	MOCK_STATIC_METHOD_1(,PROPERTIES_HANDLE, properties_clone, PROPERTIES_HANDLE, value);
	MOCK_METHOD_END(PROPERTIES_HANDLE, test_properties_handle);
...
/* received */
	...
	MOCK_STATIC_METHOD_2(,RECEIVED_HANDLE, received_create, uint32_t, section_number_value, uint64_t, section_offset_value);
	MOCK_METHOD_END(RECEIVED_HANDLE, test_received_handle);
	MOCK_STATIC_METHOD_1(,RECEIVED_HANDLE, received_clone, RECEIVED_HANDLE, value);
	MOCK_METHOD_END(RECEIVED_HANDLE, test_received_handle);
	MOCK_STATIC_METHOD_1(, void, received_destroy, RECEIVED_HANDLE, received);
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_1(, AMQP_VALUE, amqpvalue_create_received, RECEIVED_HANDLE, received);
	MOCK_METHOD_END(AMQP_VALUE, test_received_amqp_value);
	MOCK_STATIC_METHOD_1(, bool, is_received_type_by_descriptor, AMQP_VALUE, value);
	MOCK_METHOD_END(bool, true);
	MOCK_STATIC_METHOD_2(, int, amqpvalue_get_received, AMQP_VALUE, value, RECEIVED_HANDLE*, RECEIVED_handle);
	MOCK_METHOD_END(int, 0);

	MOCK_STATIC_METHOD_2(, int, received_get_section_number, RECEIVED_HANDLE, received, uint32_t*, section_number_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, received_set_section_number, RECEIVED_HANDLE, received, uint32_t, section_number_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, received_get_section_offset, RECEIVED_HANDLE, received, uint64_t*, section_offset_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, received_set_section_offset, RECEIVED_HANDLE, received, uint64_t, section_offset_value);
	MOCK_METHOD_END(int, 0);

/* accepted */

	MOCK_STATIC_METHOD_0(,ACCEPTED_HANDLE, accepted_create);
	MOCK_METHOD_END(ACCEPTED_HANDLE, test_accepted_handle);
	MOCK_STATIC_METHOD_1(,ACCEPTED_HANDLE, accepted_clone, ACCEPTED_HANDLE, value);
	MOCK_METHOD_END(ACCEPTED_HANDLE, test_accepted_handle);
	MOCK_STATIC_METHOD_1(, void, accepted_destroy, ACCEPTED_HANDLE, accepted);
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_1(, AMQP_VALUE, amqpvalue_create_accepted, ACCEPTED_HANDLE, accepted);
	MOCK_METHOD_END(AMQP_VALUE, test_accepted_amqp_value);
	MOCK_STATIC_METHOD_1(, bool, is_accepted_type_by_descriptor, AMQP_VALUE, value);
	MOCK_METHOD_END(bool, true);
	MOCK_STATIC_METHOD_2(, int, amqpvalue_get_accepted, AMQP_VALUE, value, ACCEPTED_HANDLE*, ACCEPTED_handle);
	MOCK_METHOD_END(int, 0);


/* rejected */

	MOCK_STATIC_METHOD_0(,REJECTED_HANDLE, rejected_create);
	MOCK_METHOD_END(REJECTED_HANDLE, test_rejected_handle);
	MOCK_STATIC_METHOD_1(,REJECTED_HANDLE, rejected_clone, REJECTED_HANDLE, value);
	MOCK_METHOD_END(REJECTED_HANDLE, test_rejected_handle);
	MOCK_STATIC_METHOD_1(, void, rejected_destroy, REJECTED_HANDLE, rejected);
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_1(, AMQP_VALUE, amqpvalue_create_rejected, REJECTED_HANDLE, rejected);
	MOCK_METHOD_END(AMQP_VALUE, test_rejected_amqp_value);
	MOCK_STATIC_METHOD_1(, bool, is_rejected_type_by_descriptor, AMQP_VALUE, value);
	MOCK_METHOD_END(bool, true);
	MOCK_STATIC_METHOD_2(, int, amqpvalue_get_rejected, AMQP_VALUE, value, REJECTED_HANDLE*, REJECTED_handle);
	MOCK_METHOD_END(int, 0);

	MOCK_STATIC_METHOD_2(, int, rejected_get_error, REJECTED_HANDLE, rejected, ERROR_HANDLE*, error_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, rejected_set_error, REJECTED_HANDLE, rejected, ERROR_HANDLE, error_value);
	MOCK_METHOD_END(int, 0);

/* released */

	MOCK_STATIC_METHOD_0(,RELEASED_HANDLE, released_create);
	MOCK_METHOD_END(RELEASED_HANDLE, test_released_handle);
	MOCK_STATIC_METHOD_1(,RELEASED_HANDLE, released_clone, RELEASED_HANDLE, value);
	MOCK_METHOD_END(RELEASED_HANDLE, test_released_handle);
	MOCK_STATIC_METHOD_1(, void, released_destroy, RELEASED_HANDLE, released);
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_1(, AMQP_VALUE, amqpvalue_create_released, RELEASED_HANDLE, released);
	MOCK_METHOD_END(AMQP_VALUE, test_released_amqp_value);
	MOCK_STATIC_METHOD_1(, bool, is_released_type_by_descriptor, AMQP_VALUE, value);
	MOCK_METHOD_END(bool, true);
	MOCK_STATIC_METHOD_2(, int, amqpvalue_get_released, AMQP_VALUE, value, RELEASED_HANDLE*, RELEASED_handle);
	MOCK_METHOD_END(int, 0);


/* modified */

	MOCK_STATIC_METHOD_0(,MODIFIED_HANDLE, modified_create);
	MOCK_METHOD_END(MODIFIED_HANDLE, test_modified_handle);
	MOCK_STATIC_METHOD_1(,MODIFIED_HANDLE, modified_clone, MODIFIED_HANDLE, value);
	MOCK_METHOD_END(MODIFIED_HANDLE, test_modified_handle);
	MOCK_STATIC_METHOD_1(, void, modified_destroy, MODIFIED_HANDLE, modified);
	MOCK_VOID_METHOD_END();
	MOCK_STATIC_METHOD_1(, AMQP_VALUE, amqpvalue_create_modified, MODIFIED_HANDLE, modified);
	MOCK_METHOD_END(AMQP_VALUE, test_modified_amqp_value);
	MOCK_STATIC_METHOD_1(, bool, is_modified_type_by_descriptor, AMQP_VALUE, value);
	MOCK_METHOD_END(bool, true);
	MOCK_STATIC_METHOD_2(, int, amqpvalue_get_modified, AMQP_VALUE, value, MODIFIED_HANDLE*, MODIFIED_handle);
	MOCK_METHOD_END(int, 0);

	MOCK_STATIC_METHOD_2(, int, modified_get_delivery_failed, MODIFIED_HANDLE, modified, bool*, delivery_failed_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, modified_set_delivery_failed, MODIFIED_HANDLE, modified, bool, delivery_failed_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, modified_get_undeliverable_here, MODIFIED_HANDLE, modified, bool*, undeliverable_here_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, modified_set_undeliverable_here, MODIFIED_HANDLE, modified, bool, undeliverable_here_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, modified_get_message_annotations, MODIFIED_HANDLE, modified, fields*, message_annotations_value);
	MOCK_METHOD_END(int, 0);
	MOCK_STATIC_METHOD_2(, int, modified_set_message_annotations, MODIFIED_HANDLE, modified, fields, message_annotations_value);
	MOCK_METHOD_END(int, 0);
...
/* error */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,ERROR_HANDLE, error_clone, ERROR_HANDLE, value);
...
/* open */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,OPEN_HANDLE, open_clone, OPEN_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_get_outgoing_locales, OPEN_HANDLE, open, AMQP_VALUE*, outgoing_locales_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_set_outgoing_locales, OPEN_HANDLE, open, AMQP_VALUE, outgoing_locales_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_get_incoming_locales, OPEN_HANDLE, open, AMQP_VALUE*, incoming_locales_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_set_incoming_locales, OPEN_HANDLE, open, AMQP_VALUE, incoming_locales_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_get_offered_capabilities, OPEN_HANDLE, open, AMQP_VALUE*, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_set_offered_capabilities, OPEN_HANDLE, open, AMQP_VALUE, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_get_desired_capabilities, OPEN_HANDLE, open, AMQP_VALUE*, desired_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, open_set_desired_capabilities, OPEN_HANDLE, open, AMQP_VALUE, desired_capabilities_value);
...
/* begin */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,BEGIN_HANDLE, begin_clone, BEGIN_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, begin_get_offered_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE*, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, begin_set_offered_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, begin_get_desired_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE*, desired_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, begin_set_desired_capabilities, BEGIN_HANDLE, begin, AMQP_VALUE, desired_capabilities_value);
...
/* attach */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,ATTACH_HANDLE, attach_clone, ATTACH_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, attach_get_offered_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE*, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, attach_set_offered_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE, offered_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, attach_get_desired_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE*, desired_capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, attach_set_desired_capabilities, ATTACH_HANDLE, attach, AMQP_VALUE, desired_capabilities_value);
...
/* flow */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,FLOW_HANDLE, flow_clone, FLOW_HANDLE, value);
...
/* transfer */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,TRANSFER_HANDLE, transfer_clone, TRANSFER_HANDLE, value);
...
/* disposition */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,DISPOSITION_HANDLE, disposition_clone, DISPOSITION_HANDLE, value);
...
/* detach */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,DETACH_HANDLE, detach_clone, DETACH_HANDLE, value);
...
/* end */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,END_HANDLE, end_clone, END_HANDLE, value);
...
/* close */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,CLOSE_HANDLE, close_clone, CLOSE_HANDLE, value);
...
/* sasl-mechanisms */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_MECHANISMS_HANDLE, sasl_mechanisms_create, AMQP_VALUE, sasl_server_mechanisms_value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_MECHANISMS_HANDLE, sasl_mechanisms_clone, SASL_MECHANISMS_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, sasl_mechanisms_get_sasl_server_mechanisms, SASL_MECHANISMS_HANDLE, sasl_mechanisms, AMQP_VALUE*, sasl_server_mechanisms_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, sasl_mechanisms_set_sasl_server_mechanisms, SASL_MECHANISMS_HANDLE, sasl_mechanisms, AMQP_VALUE, sasl_server_mechanisms_value);

/* sasl-init */

	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_INIT_HANDLE, sasl_init_create, const char*, mechanism_value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_INIT_HANDLE, sasl_init_clone, SASL_INIT_HANDLE, value);
...
/* sasl-challenge */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_CHALLENGE_HANDLE, sasl_challenge_clone, SASL_CHALLENGE_HANDLE, value);
...
/* sasl-response */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_RESPONSE_HANDLE, sasl_response_clone, SASL_RESPONSE_HANDLE, value);
...
/* sasl-outcome */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SASL_OUTCOME_HANDLE, sasl_outcome_clone, SASL_OUTCOME_HANDLE, value);
...
/* source */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,SOURCE_HANDLE, source_clone, SOURCE_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, source_get_outcomes, SOURCE_HANDLE, source, AMQP_VALUE*, outcomes_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, source_set_outcomes, SOURCE_HANDLE, source, AMQP_VALUE, outcomes_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, source_get_capabilities, SOURCE_HANDLE, source, AMQP_VALUE*, capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, source_set_capabilities, SOURCE_HANDLE, source, AMQP_VALUE, capabilities_value);

/* target */

	DECLARE_GLOBAL_MOCK_METHOD_0(amqp_definitions_mocks, ,TARGET_HANDLE, target_create);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,TARGET_HANDLE, target_clone, TARGET_HANDLE, value);
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, target_get_capabilities, TARGET_HANDLE, target, AMQP_VALUE*, capabilities_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, target_set_capabilities, TARGET_HANDLE, target, AMQP_VALUE, capabilities_value);
...
/* header */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,HEADER_HANDLE, header_clone, HEADER_HANDLE, value);
...
/* properties */
	...
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,PROPERTIES_HANDLE, properties_clone, PROPERTIES_HANDLE, value);
...
/* received */
	...
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, ,RECEIVED_HANDLE, received_create, uint32_t, section_number_value, uint64_t, section_offset_value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,RECEIVED_HANDLE, received_clone, RECEIVED_HANDLE, value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , void, received_destroy, RECEIVED_HANDLE, received);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , AMQP_VALUE, amqpvalue_create_received, RECEIVED_HANDLE, received);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , bool, is_received_type_by_descriptor, AMQP_VALUE, value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, amqpvalue_get_received, AMQP_VALUE, value, RECEIVED_HANDLE*, RECEIVED_handle);

	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, received_get_section_number, RECEIVED_HANDLE, received, uint32_t*, section_number_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, received_set_section_number, RECEIVED_HANDLE, received, uint32_t, section_number_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, received_get_section_offset, RECEIVED_HANDLE, received, uint64_t*, section_offset_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, received_set_section_offset, RECEIVED_HANDLE, received, uint64_t, section_offset_value);

/* accepted */

	DECLARE_GLOBAL_MOCK_METHOD_0(amqp_definitions_mocks, ,ACCEPTED_HANDLE, accepted_create);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,ACCEPTED_HANDLE, accepted_clone, ACCEPTED_HANDLE, value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , void, accepted_destroy, ACCEPTED_HANDLE, accepted);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , AMQP_VALUE, amqpvalue_create_accepted, ACCEPTED_HANDLE, accepted);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , bool, is_accepted_type_by_descriptor, AMQP_VALUE, value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, amqpvalue_get_accepted, AMQP_VALUE, value, ACCEPTED_HANDLE*, ACCEPTED_handle);


/* rejected */

	DECLARE_GLOBAL_MOCK_METHOD_0(amqp_definitions_mocks, ,REJECTED_HANDLE, rejected_create);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,REJECTED_HANDLE, rejected_clone, REJECTED_HANDLE, value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , void, rejected_destroy, REJECTED_HANDLE, rejected);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , AMQP_VALUE, amqpvalue_create_rejected, REJECTED_HANDLE, rejected);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , bool, is_rejected_type_by_descriptor, AMQP_VALUE, value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, amqpvalue_get_rejected, AMQP_VALUE, value, REJECTED_HANDLE*, REJECTED_handle);

	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, rejected_get_error, REJECTED_HANDLE, rejected, ERROR_HANDLE*, error_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, rejected_set_error, REJECTED_HANDLE, rejected, ERROR_HANDLE, error_value);

/* released */

	DECLARE_GLOBAL_MOCK_METHOD_0(amqp_definitions_mocks, ,RELEASED_HANDLE, released_create);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,RELEASED_HANDLE, released_clone, RELEASED_HANDLE, value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , void, released_destroy, RELEASED_HANDLE, released);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , AMQP_VALUE, amqpvalue_create_released, RELEASED_HANDLE, released);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , bool, is_released_type_by_descriptor, AMQP_VALUE, value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, amqpvalue_get_released, AMQP_VALUE, value, RELEASED_HANDLE*, RELEASED_handle);


/* modified */

	DECLARE_GLOBAL_MOCK_METHOD_0(amqp_definitions_mocks, ,MODIFIED_HANDLE, modified_create);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, ,MODIFIED_HANDLE, modified_clone, MODIFIED_HANDLE, value);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , void, modified_destroy, MODIFIED_HANDLE, modified);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , AMQP_VALUE, amqpvalue_create_modified, MODIFIED_HANDLE, modified);
	DECLARE_GLOBAL_MOCK_METHOD_1(amqp_definitions_mocks, , bool, is_modified_type_by_descriptor, AMQP_VALUE, value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, amqpvalue_get_modified, AMQP_VALUE, value, MODIFIED_HANDLE*, MODIFIED_handle);

	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_get_delivery_failed, MODIFIED_HANDLE, modified, bool*, delivery_failed_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_set_delivery_failed, MODIFIED_HANDLE, modified, bool, delivery_failed_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_get_undeliverable_here, MODIFIED_HANDLE, modified, bool*, undeliverable_here_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_set_undeliverable_here, MODIFIED_HANDLE, modified, bool, undeliverable_here_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_get_message_annotations, MODIFIED_HANDLE, modified, fields*, message_annotations_value);
	DECLARE_GLOBAL_MOCK_METHOD_2(amqp_definitions_mocks, , int, modified_set_message_annotations, MODIFIED_HANDLE, modified, fields, message_annotations_value);
