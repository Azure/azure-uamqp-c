...
TEST_FUNCTION(frame_codec_create_with_NULL_on_error_decode_fails)
{
	...
	// act
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(NULL, TEST_ERROR_CONTEXT, consolelogger_log);
...
TEST_FUNCTION(frame_codec_create_with_NULL_frame_codec_decode_error_calback_context_succeeds)
{
	...
	// act
	FRAME_CODEC_HANDLE frame_codec = frame_codec_create(test_frame_codec_decode_error, NULL, consolelogger_log);
